#!/usr/bin/env python
"""
The objective of this script is to look for all image files in a folder and crop parts of it that contain a fod. The
cropped images will be saved along with a xml annontation in pascal format
The following is an example of the arguments need to run this script
python crop_images_labels2pascal.py
/media/cruz/data/datasets/19dez_rpi_fod/images/
/media/cruz/data/datasets/19dez_rpi_fod/annotations/19dez_rpi.json
/media/cruz/data/datasets/19dez_rpi_fod/pascal/images/
...
def main(argv):
    ...
    cv2.namedWindow('cropped_img_copy', cv2.WINDOW_NORMAL)
